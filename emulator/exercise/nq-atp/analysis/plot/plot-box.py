...
plot = sns.boxplot(data=data_vio, x="ecnt", y="pcnt", hue="type", linewidth=1, palette=my_pal, ax=ax)
...
f.savefig("./origin-bmv2-link-box.pdf", bbox_inches='tight', pad_inches=0)
