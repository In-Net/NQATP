...
ax.legend(handles=ax.lines, labels=["DriftSwitch\n(No Clustering)","DriftSwitch\n(One Cluster)","3 Tier Polling"], frameon=False, loc="center", bbox_to_anchor=(0.5,1.2), fontsize=12, ncol=3, columnspacing=0.5, handletextpad=0.3, handlelength=1.5)
...
plt.tight_layout()
f.savefig("./large-scale-emulation-extended.pdf", bbox_inches='tight', pad_inches=0)

plt.tight_layout()
f.savefig("./large-scale-emulation.pdf", bbox_inches='tight', pad_inches=0)
